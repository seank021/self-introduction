...
- 2002년 10월 21일입니다.
- 10월 즈음 카카오톡에 생일 알림이 뜬다면 꼭 축하해주세요~!

## 2. 성별 및 기본 정보

- 여성입니다.
- 서울시 동작구에 살고 있어요! 근처에 계시다면 부르는 거 언제든 환영입니다~!
- 서울대학교 언어학과에 재학 중이고, 21학번으로 현재 3학년입니다. 복수전공으로 컴퓨터공학부 하고 있습니다.

## 3. 가족관계

- 부모님과 4살 차이 나는 언니 한 명이 있습니다.

## 4. 키, 몸무게

- 키는 2월 말에 건강검진을 하면서 쟀는데, 158.2cm가 나왔습니다. 고3 초기에 쟀던 게 156cm이었는데, 그새 컸나봐요^^ 너무 행복합니다.
- 몸무게는 비밀이에요.
...
- 말하는 걸 좋아해서... 텐션이 올라가면 좀 시끄러울 수 있어요.

## 7. 별명

- 별명은 되게 많은데 몇 개만 나열하자면...!
    > (1) 김세수, washing face
    - 단순히 이름이 "세안"이어서 ㅎ
    > (2) 새, 참새, 뱁새
    - 제 얼굴이 새를 닮았다고 (a.k.a '새'상) 해서 붙여졌어요.
    > (3) 지미 뉴트론
    - 고등학교 때 숏컷이었는데, 꽤 심한 곱슬이어서 붙여진 별명이에요. 근데 멋사 오티 뒤풀이에서 박O현 님이 지미 뉴트론 닮았다고 한 거 보면... 닮았나봐요 ㅎ
    <br><br>
    <img src = "https://w7.pngwing.com/pngs/706/145/png-transparent-the-adventures-of-jimmy-neutron-boy-genius-jimmy-neutron-youtube-carl-wheezer-ms-fowl-smart-boy-logo-face-head-boy-thumbnail.png" width="170" height="300"></img> &nbsp;&nbsp; << (지미뉴트론 사진 첨부)
    > (4) 아리
    - 멋사에서 사람들을 2번 만났는데, 2번 만날 때마다 이 얘기를 들었어요. <닥터 슬럼프>의 "아리"라는 캐릭터인데, 닮았나요?
    <br><br>
    <img src = "https://extmovie.com/files/attach/images/135/341/160/016/8de15fd6dc9c67593a9a197d34ecd38c.jpg" width="250" height="250"></img> &nbsp;&nbsp; << (아리 사진 첨부)
